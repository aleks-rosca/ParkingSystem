...
public class CreateDatabase {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        conn.update(sql);
        String sql2 = "set search_path ='parking';\n" +
                "\n" +
                "\n" +
                "\n" +
                "insert into employee values('E1987','Dennis','May');"+
                "insert into empres values(Current_date+1,'E1987');\n" +

                "insert into guestres values(Current_date+1,'G1234','Mette','Frederiksen');\n" +
                "\n" +
                "insert into parkinglot values ('EV12345','P', Current_date);\n" +
                "insert into parkinglot values('E1987','E',Current_date);\n" ;
